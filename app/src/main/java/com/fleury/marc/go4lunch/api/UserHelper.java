...
public class UserHelper {
    ...
    public static Task<Void> createUser(String uid, String username, String restaurant, String urlPicture) {
        User userToCreate = new User(uid, username, restaurant, urlPicture);
